...
{
    //EstoqueService representa uma ação conhecida da linguagem ubíqua!
    public class EstoqueService : IEstoqueService
    {
        ...
        private async Task<bool> DebitarItemEstoque(Guid produtoId, int quantidade)
        {
            ...
            {
                await _mediatorHandler.PublicarNotificacao(new DomainNotification("Estoque",
            ...
            //TODO: 10 pode ser parametrizavel em arquivo de config
