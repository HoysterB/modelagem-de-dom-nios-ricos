...
namespace NerdStore.Catalogo.Domain.Events
{
        ...
        INotificationHandler<PedidoIniciadoEvent>
    {
        ...
        public async Task Handle(ProdutoAbaixoEstoqueEvent mensagem, 
        ...
        {
            //retorna um boolean de acordo se commitou ou não no banco
            ...
            {
                await _mediatorHandler.PublicarEvento(
                    new PedidoEstoqueRejeitadoEvent(message.PedidoId, message.ClienteId));
            }
        }
    }
}